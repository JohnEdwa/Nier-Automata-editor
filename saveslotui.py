...
class SaveSlotUi(QWidget):
    ...
    def widget_init(self):
        ...
        self.ui.gameDataHeaderLabel.setText(binascii.hexlify(self._savedata.gamedata_header).decode())
    ...
    def importgamedataheader(self):
        ...
        self.gameDataHeaderLabel.setText(binascii.hexlify(self._savedata.gamedata_header))
    ...
    def on_chip_clicked(self): pass

    def on_item_clicked(self): pass
        # w = ItemsManagerUI(self)
        # w.show()
